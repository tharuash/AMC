...
<body id="page-top" >
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		...
		<a class="navbar-brand mr-1" href="staff-dashboard.jsp">Home</a>
						...
						<table class="table table-bordered" id="dataTable"
							...
							<c:forEach items="${list}" var="appointment">
								...
								<tr>
									...
									<td>${appointment.durationLeft}</td>
									<td>${appointment.charge}</td>
									<td id="isPaid">${appointment.isPaid}</td>
									
								

									<td><a
										href="${pageContext.request.contextPath}/StaffServlet?action=load_appointment&id=${appointment.appointmentId}"
										class="btn btn-primary">Edit</a> | <a
										href="${pageContext.request.contextPath}/StaffServlet?action=delete_appointment&id=${appointment.appointmentId}"
