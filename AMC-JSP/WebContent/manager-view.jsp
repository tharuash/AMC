            ...
            <div >
              <table class="table table-bordered" id="dataTable"  style="overflow-x: auto; width: 100%; cellspacing:0">
				...
				<tr>
					...
					<td>${user.role}</td>
					<td> 
						<a href = "${pageContext.request.contextPath}/ManagerServlet?action=update&id=${user.userId}" class="btn btn-primary" >Edit</a> 
						| 
						<a href = "${pageContext.request.contextPath}/ManagerServlet?action=delete&id=${user.userId}" class="btn btn-primary" >Delete</a> 
					</td>
				</tr>
