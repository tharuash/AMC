	...
	<div class="row">
		<div class="col-xl-3 col-sm-6 mb-3">
			<div class="card text-white bg-primary o-hidden h-100">
				<div class="card-body">
					...
					<div class="mr-5">Add Appointment</div>
				</div>
				<a class="card-footer text-white clearfix small z-1"
					href="${pageContext.request.contextPath}/StaffServlet?action=load_appointment_details">
					<span class="float-left">Add new appointments.</span> <span
		...
		<div class="col-xl-3 col-sm-6 mb-3">
			<div class="card text-white bg-warning o-hidden h-100">
				...
				<a class="card-footer text-white clearfix small z-1"
					href="${pageContext.request.contextPath}/StaffServlet?action=view_appointments">
					<span class="float-left">View And edit appointments.</span> <span
					class="float-right"> <i class="fas fa-angle-right"></i>
				</span>
				</a>
			</div>
