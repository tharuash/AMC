						...
						<table class="table table-bordered" id="dataTable"
							...
							<c:forEach items="${list}" var="user">
								...
								<tr>
									...
									<td><a
										href="${pageContext.request.contextPath}/StaffServlet?action=load_customer&id=${user.userId}"
										class="btn btn-primary">Edit</a> | <a
										href="${pageContext.request.contextPath}/StaffServlet?action=delete_customer&id=${user.userId}"
