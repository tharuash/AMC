		...
		<div class="col-xl-3 col-sm-6 mb-3">
			<div class="card text-white bg-primary o-hidden h-100">
				...
				<a class="card-footer text-white clearfix small z-1"
					href="${pageContext.request.contextPath}/DoctorServlet?action=view_appointments">
					<span class="float-left">View your appointments and edit.</span> <span
		...
		<div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Customer History</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="${pageContext.request.contextPath}/DoctorServlet?action=get_customer_list">
                <span class="float-left">Get appointments of each customers.</span>
